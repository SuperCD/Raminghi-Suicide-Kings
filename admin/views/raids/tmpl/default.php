...
<div id="editcell">
    ...
    for ($i=0, $n=count( $this->importraids ); $i < $n; $i++)
    {
        ...
        $importlink = 'index.php?option=com_skmanager&amp;controller=raidedit&amp;task=importraid&amp;raidid='.$row['raid_id'];              
        ?>
        <tr class="<?php echo "row$k"; ?>">
            ...
            <td>
                <?php echo date('Y-m-d H:i:s', intval($row['start_time'])); ?>
            </td>
            <td>
                <a href=<?php echo $importlink?>>Importa raid</a>
            </td>                     
        </tr>
        <?php
        $k = 1 - $k;
